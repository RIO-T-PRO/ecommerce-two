...
const CheckoutPage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-10 lg:grid lg:grid-cols-3 lg:gap-8">
      <div className="lg:col-span-2 flex flex-col gap-6">
        <h1 className="text-text-light text-2xl font-bold">Checkout</h1>
            ...
            {cart.map((item) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  />
                  <div>
                    <h2 className="text-text-light font-medium">{item.name}</h2>
      ...
      <aside className="mt-8 lg:mt-0 rounded-xl bg-card-bg p-6 h-fit sticky top-24 flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex justify-between text-text-muted">
            <p>Taxes</p>
            <p className="font-medium text-text-light">${taxCost.toFixed(2)}</p>
          </div>
        ...
        <div className="relative mt-4">
          ...
          />
          <button className="absolute top-1/2 -translate-y-1/2 right-2 rounded-md h-9 px-4 text-sm font-bold bg-text-primary text-text-light hover:bg-text-primary/80 transition-colors">
            Apply
          </button>
        </div>
        ...
        <button
          ...
          className="mt-4 w-full h-12 rounded-lg bg-text-primary text-text-light font-bold text-base hover:bg-text-primary/80 transition-colors"
        >
          Complete Purchase
        </button>
      </aside>
